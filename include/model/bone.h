...
public:
	...
	{
		// Handle empty or single keyframe
		if (m_NumPositions <= 1)
			return 0;
		...
		// If animation time is beyond last keyframe, return the second-to-last index
		// This allows interpolation between the last two keyframes or clamping to the last
...
private:
	float GetScaleFactor(float lastTimeStamp, float nextTimeStamp, float animationTime)
	{
		...
		// Clamp to [0, 1] range to prevent extrapolation issues
